...
@with_token_middleware
def delete_project(
    project_id: str, sessionId: str = None, confirm: Optional[str] = None
) -> str:
    """
...
@with_token_middleware
def delete_service(
    service_id: str, sessionId: str = None, confirm: Optional[str] = None
) -> str:
    """
...
def delete_deployment(
    deployment_id: str, sessionId: str = None, confirm: Optional[str] = None
) -> str:
    """
...
def update_notification_settings(
    ...
    return make_authenticated_api_request(
        "PUT", "/notifications/settings", json_data=data
    )
