...
def list_accounts(
    size: Optional[str] = None, page: Optional[str] = None, search: Optional[str] = None
) -> str:
...
def get_deployment_metrics(
    deployment_id: str, start_time: Optional[str] = None, end_time: Optional[str] = None
) -> str:
...
def list_invoices(
    size: Optional[str] = None, page: Optional[str] = None, status: Optional[str] = None
) -> str:
...
def get_notifications(
    size: Optional[str] = None, page: Optional[str] = None, type: Optional[str] = None
) -> str:
