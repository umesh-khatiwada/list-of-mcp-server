...
class MCPClientSimulator:
    ...
    def _start_server_process(self):
        ...
        logger.info(
            f"Environment: PYTHONPATH={env.get('PYTHONPATH')}, PYTHONNOUSERSITE={env.get('PYTHONNOUSERSITE')}"
        )
    ...
    def _send_http_request(self, request: Dict[str, Any]) -> Dict[str, Any]:
        ...
        response = requests.post(self.server_url, json=request, timeout=self.timeout)
    ...
    def _generate_mock_response(self, request: Dict[str, Any]) -> Dict[str, Any]:
        ...
        """
        logger.info(
            f"[MOCK] Generating mock response for request: {request.get('type')}"
        )
        ...
        if request.get("type") == "list_tools":
            ...
            response["result"] = {
                "tools": [
                    ...
                    {
                        "name": "set_namespace",
                        "description": "Set the current namespace",
                    },
                    {
                    ...
                    },
                    {
                        ...
                        "description": "Audit pod security settings",
                    },
                    {
                        "name": "validate_resource",
                        "description": "Validate a Kubernetes resource",
                    },
                    {
            ...
            if tool_name == "get_pods":
                ...
                response["result"] = {
                    ...
                    "probes": {
                        "readiness": {"configured": True, "type": "httpGet"},
                        "liveness": {"configured": True, "type": "httpGet"},
                ...
                if "invalid" in args.get("filepath", "").lower():
                    ...
                    response["result"] = {"valid": True, "errors": []}
                ...
                response["result"] = {
                    ...
                    "pod": args.get("name", "mock-pod"),
                    "namespace": args.get("namespace", "default"),
                    "securityContext": {"configured": True},
                    "privileged": False,
                    "hostNetwork": False,
                    "hostPID": False,
                    "hostIPC": False,
                ...
                response["result"] = {
                    ...
                    "system_pods": [
                        {"name": "mock-system-pod", "namespace": "kube-system"}
                    ],
                }
    ...
    def call_tool(self, tool_name: str, args: Dict[str, Any]) -> Dict[str, Any]:
        ...
        """
        request = {"type": "tool_call", "name": tool_name, "args": args}
        return self.send_request(request)
