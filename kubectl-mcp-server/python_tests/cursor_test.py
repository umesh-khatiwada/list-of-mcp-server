...
if __name__ == "__main__":
    ...
    if success:
        print(
            "The module can be invoked correctly. Cursor should be able to use it with this configuration:"
        )
        print(
            """
{
  "mcpServers": {
    "kubernetes": {
      ...
      "args": ["-m", "kubectl_mcp_tool.cli.cli", "serve"]
        ...
        print(
            "2. Try using an absolute path to the Python executable in the Cursor configuration"
        )
