...
class KubernetesOperations:
    ...
    # Pod Management
    def create_pod(
        self, pod_spec: Dict[str, Any], namespace: str = "default"
    ) -> Dict[str, Any]:
        """Create a pod from specification."""
        try:
            pod = self.core_v1.create_namespaced_pod(namespace=namespace, body=pod_spec)
            return {
                "status": "success",
    ...
    def delete_pod(self, pod_name: str, namespace: str = "default") -> Dict[str, Any]:
        ...
        try:
            ...
            return {"status": "error", "error": f"Failed to delete pod: {e.reason}"}

    # Deployment Management
    def create_deployment(
        self, deployment_spec: Dict[str, Any], namespace: str = "default"
    ) -> Dict[str, Any]:
        """Create a deployment."""
        try:
    ...
    def update_deployment(
        self, name: str, deployment_spec: Dict[str, Any], namespace: str = "default"
    ) -> Dict[str, Any]:
        """Update a deployment."""
        try:
            deployment = self.apps_v1.patch_namespaced_deployment(
                name=name, namespace=namespace, body=deployment_spec
            )
            return {
                "status": "success",
    ...
    def rollback_deployment(
        self, name: str, revision: Optional[int] = None, namespace: str = "default"
    ) -> Dict[str, Any]:
    ...
    def create_service(
        ...
        try:
            ...
            return {"status": "error", "error": f"Failed to create service: {e.reason}"}
    ...
    def delete_service(self, name: str, namespace: str = "default") -> Dict[str, Any]:
        ...
        try:
            ...
            return {"status": "error", "error": f"Failed to delete service: {e.reason}"}

    # ConfigMap and Secret Management
    def create_config_map(
        self, name: str, data: Dict[str, str], namespace: str = "default"
    ) -> Dict[str, Any]:
        """Create a ConfigMap."""
        try:
    ...
    def create_secret(
        ...
        try:
            ...
            return {"status": "error", "error": f"Failed to create Secret: {e.reason}"}

    # Network Operations
    def create_network_policy(
        self, policy_spec: Dict[str, Any], namespace: str = "default"
    ) -> Dict[str, Any]:
        """Create a NetworkPolicy."""
        try:
            policy = self.networking_v1.create_namespaced_network_policy(
                namespace=namespace, body=policy_spec
            )
            return {
                "status": "success",
    ...
    def create_ingress(
        self, ingress_spec: Dict[str, Any], namespace: str = "default"
    ) -> Dict[str, Any]:
        """Create an Ingress."""
        try:
            ingress = self.networking_v1.create_namespaced_ingress(
                namespace=namespace, body=ingress_spec
            )
            return {
                "status": "success",
            ...
            return {"status": "error", "error": f"Failed to create Ingress: {e.reason}"}
    ...
    def get_contexts(self) -> Dict[str, Any]:
        ...
        try:
            ...
            result = self.run_command(cmd)
            return {"status": "success", "contexts": result}
        except Exception as e:
            return {"status": "error", "error": f"Failed to get contexts: {str(e)}"}
    ...
    def switch_context(self, context_name: str) -> Dict[str, Any]:
        ...
        try:
            ...
            return {"status": "error", "error": f"Failed to switch context: {str(e)}"}
    ...
    def list_pods(
        ...
        try:
            ...
            return {"status": "error", "error": f"Failed to list pods: {e.reason}"}
        ...
        try:
            ...
            for svc in services.items:
                ...
                service_info = {
                    ...
                    if hasattr(svc.spec, "external_i_ps")
                    else None,
                    "ports": ports,
            ...
            return {"status": "error", "error": f"Failed to list services: {e.reason}"}
        ...
        try:
            ...
            for deploy in deployments.items:
                ...
                for container in deploy.spec.template.spec.containers:
                    container_info = {"name": container.name, "image": container.image}
                    containers.append(container_info)
    ...
    def list_nodes(self, label_selector: Optional[str] = None) -> Dict[str, Any]:
        ...
        try:
            ...
            for node in nodes.items:
                addresses = {
                    addr.type: addr.address for addr in node.status.addresses or []
                }
                node_info = {
            ...
            return {"status": "error", "error": f"Failed to list nodes: {e.reason}"}
    ...
    def explain_resource(
        self, resource: str, api_version: Optional[str] = None, recursive: bool = False
    ) -> Dict[str, Any]:
        ...
        try:
            ...
            return {"status": "error", "error": f"Failed to explain resource: {str(e)}"}
    ...
    def list_api_resources(
        ...
        try:
            ...
            if len(lines) < 2:  # Need at least header and one resource
                return {"status": "success", "resources": [], "count": 0}
            ...
            for line in lines[1:]:
                ...
                namespaced = (
                    line[apiversion_end:namespaced_end].strip().lower() == "true"
                )
    ...
    def describe_pod(self, pod_name: str, namespace: str = "default") -> Dict[str, Any]:
        ...
        try:
                ...
                if container_status and container_status.state:
                    if container_status.state.running:
                        state = {
                            "status": "running",
                            "started_at": str(
                                container_status.state.running.started_at
                            ),
                        }
            ...
            return {"status": "success", "pod": pod_description}
        except ApiException as e:
            if e.status == 404:
                return {
                    "status": "error",
            ...
            return {"status": "error", "error": f"Failed to describe pod: {e.reason}"}
        except Exception as e:
            return {"status": "error", "error": f"Failed to describe pod: {str(e)}"}
    ...
    def _get_error_suggestions(error_type: str) -> List[str]:
        ...
        return suggestions.get(
            error_type, ["Check pod logs and events for more details"]
        )
