...
def frame_jsonrpc_message(
    data: Dict[str, Any], message_id: Optional[str] = None
) -> str:
    """
    ...
    try:
        ...
        return (
            json.dumps(error_message, ensure_ascii=True, separators=(",", ":")) + "\n"
        )
...
class ClaudeMessageFramer:
    ...
    def frame_response(
        self, data: Dict[str, Any], request_id: Optional[str] = None
    ) -> str:
        """
