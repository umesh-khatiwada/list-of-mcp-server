...
async def ping_server():
    ...
    init_request = {
        ...
        "id": 1,
        "method": "initialize",
        "params": {"clientInfo": {"name": "kubectl-ping", "version": "1.0.0"}},
    }
    ...
    ping_request = {
        ...
        "params": {"name": "kubernetes_ping", "arguments": {"query": "ping test"}},
    }
    ...
    shutdown_request = {"jsonrpc": "2.0", "id": 3, "method": "shutdown", "params": {}}
