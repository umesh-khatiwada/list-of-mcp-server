...
class KubernetesDiagnostics:
    ...
    def get_pod_logs(
        ...
        try:
            ...
            return {"status": "error", "error": f"Failed to get pod logs: {e.reason}"}
    ...
    def analyze_pod_logs(
        ...
        try:
            ...
            return {"status": "error", "error": f"Failed to analyze pod logs: {str(e)}"}
    ...
    def get_pod_events(
        ...
        try:
            ...
            return {"status": "error", "error": f"Failed to get pod events: {e.reason}"}
